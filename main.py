...
issues_result = max_result # Issue shows all papers fetched from arXiv
...
f_rm.write("The project automatically fetches the latest papers from arXiv based on keywords.\n\nThe subheadings in the README file represent the search keywords.\n\nOnly the most recent articles for each keyword are retained, up to a maximum of {0} papers.\n\nYou can click the 'Watch' button to receive daily email notifications.\n\nLast update: {1}\n\n".format(readme_result, current_date))
...
f_is.write("---\n")
f_is.write("**Please check the [Github](https://github.com/NeoFii/Daily_ArXiv) page for a better reading experience and more papers.**\n\n")
...
for keyword in keywords:
    ...
    rm_table = generate_table(papers[:readme_result])
